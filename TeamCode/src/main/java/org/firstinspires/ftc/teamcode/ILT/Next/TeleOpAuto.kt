...
class AutoAimTeleOp : NextFTCOpMode() {
    ...
    override fun onInit() {
        ...
        PanelsConfigurables.INSTANCE.refreshClass(AutoAimCalculator)
        // Don't overwrite alliance here – set it on the Panels dashboard
        RobotState.reset()
        follower.pose = Pose(0.0, 0.0, 0.0)

        // Don't overwrite AutoAimCalculator tunables – tune via Panels dashboard
    }
